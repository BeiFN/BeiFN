let{$, on, getSize, getAbsPosition, removeClassName} = Utils;
class Magnifier{
    constructor(){
        // 获取元素
    ...
    // 初始化
    init(){
        on(this.smallImgWrap,"mouseenter", this.show.bind(this));
        on(this.smallImgWrap,"mouseleave", this.hide.bind(this));
        on(this.smallImgWrap,"mousemove",this.handleMousemove.bind(this));
