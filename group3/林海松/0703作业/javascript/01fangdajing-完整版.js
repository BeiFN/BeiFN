...
Magnifier.prototype.changeImg = function(evt,ele){
      ...
      this.small_img.src = this.list[index].small_pic; 
      this.small_cube.style.backgroundImage = "url("+this.list[index].cube_pic+")";
      this.big_img.src = "url("+this.list[index].big_pic+")";
}
...
Magnifier.prototype.hanlderMousemove = function(evt){//种种计算
