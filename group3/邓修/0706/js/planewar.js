...
class Core {
      ...
      animate() {
            ...
            this.loading = setInterval(() => {
                  ...
                  this.plane_loading.style.backgroundImage = "url("+Core.loading_img_list["loading"+(++index % 3 + 1)]+")";
            }, 800);
            let positionY = 0;
            let speed = 5;
            // console.log(this.hardLevel);
            switch (Core.hardLevel) {//根据难度等级调整背景滑动速度
      ...
      static hardLevel;
      static loading_img_list={
            loading1:"https://upload-images.jianshu.io/upload_images/18473180-73f957bfd4b215e5.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240",
            loading2:"https://upload-images.jianshu.io/upload_images/18473180-c347977f1310a6f8.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240",
            loading3:"https://upload-images.jianshu.io/upload_images/18473180-aa833159087984f0.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240"
      };
}
// 功能调用;
class Plane {
