 ...
 function eleMove(ele){
      ...
      timer = setInterval( function (){
            ...
            if(numTop >= 400){
                  ...
                  gra.innerHTML = grade; 
                  gra.style.color="red" ;
                  defen.innerHTML=grade;
                  defen.style.color="red" ;
                  // 动画运行结束删除元素;
                  setTimeout( function (){
                        removeRecord(ele)
                        ele.remove();
...
// 创建子弹;
 ...
 var t = 30;
	var time = document.getElementById("clock");
     var inter=null;
	inter=setInterval(function fun() {
		t--;
          time.innerHTML = t;
          if(t<=10)time.style.color="red";
		if(t <= 0) {
 ...
 var yu=setInterval( createRandomLetter , 1000);
