...
class WaterFall{
    ...
    changeContainerWidth(){
        ...
        this.conttainer.style.width = this.count * 250 + "px";
    }
    render(list){
        let html = "";
    ...
    sort(){
        let children = thsi.wrapper.children;
        ...
        let maxHeight = Math.max.apply(false , this.heigthArray);
        this.container.style.height = maxHeight + "px";
        console.log(this.heigthArray);
    }
