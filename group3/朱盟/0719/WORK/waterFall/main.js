...
// let $$ = $.noConflict(); //jquery 放弃$
// // JQ 数据接口
// $$(document).ready(function () {
//     let url = "http://localhost/duitang";
//     let data = {
...
//             new WFV({
//                 data: response.data.object_list
//             })
//         }
//     }).then((res) => {
//         console.log(res)
...
class WFV {
    constructor({
        ...
        this.startNext = this.data.start;
...
class WFVPlus extends WFV {

    render(data) {
        // console.log(data);
        let loadimg = `https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1563244462837&di=d361b540ec57ea7c054a94e5a403b835&imgtype=0&src=http%3A%2F%2Fphotocdn.sohu.com%2F20150605%2Fmp17826536_1433492197010_5.gif`;

        this.wrapper.innerHTML += this.templateEngine((item, ) => {
