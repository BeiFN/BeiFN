...
function move(target , dom , attr){
      ...
      dom.timer = setInterval(function(){
            var len = attr === "opacity" ? parseInt(getComputedStyle(dom)[attr]*100) : parseInt(getComputedStyle(dom)[attr]);
            ...
            if(target === len){
                  ...
                  attr === "opacity" ? dom.style[attr] = (speed + len)/100 : dom.style[attr] = speed + len + "px";
            }
      },50)
