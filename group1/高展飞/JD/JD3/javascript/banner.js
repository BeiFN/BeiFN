 ...
 *  */
 ...
 function Banner(selector,s,prev,next,wrapper,options){
      // 当前显示哪个图片;
      this.nowIndex = 0;
      //
      this.state = "normal";
      ...
      this.sliders  = this.main.querySelectorAll(s);
     
      this.btn_prev = this.main.querySelector(prev);
      this.btn_next = this.main.querySelector(next);
