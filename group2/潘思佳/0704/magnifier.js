...
Magnifier.prototype.changePic = function(evt) {
...
Magnifier.prototype.mouseEnterHandler = function() {
    this.cube.style.display = "block";
    this.bigBox.style.display = "block";
    this.smallImg.style.opacity = "0.3";
}

Magnifier.prototype.mouseLeaveHandler = function() {
    this.cube.style.display = "none";
    this.bigBox.style.display = "none";
    this.smallImg.style.opacity = "1";
}

Magnifier.prototype.mouseMoveHandler = function(evt) {
    var e = evt || window.event;
...
Magnifier.prototype.move = function(cube_position, big_box_position) {
...
Magnifier.prototype.getBigImgPosition = function(x, y) {
