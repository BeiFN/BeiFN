...
function handlerStart(evt) {
    ...
    document.removeEventListener("mousemove",_tampHandlerMove)
    document.addEventListener("mousemove", _tampHandlerMove = handlerMove.bind(false,{offsetWidth:e.offsetX,offsetHeight:e.offsetY}));
}

function handlerMove(offset,evt) {
    var e = evt||event
    // var clientXWidth = e.clientX;
    // var clientYHeight = e.clientY;
    var Xwidth = e.clientX - offset.offsetWidth;
    var Yheight = e.clientY - offset.offsetHeight;
