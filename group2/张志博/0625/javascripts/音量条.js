...
var progressPoint = $("#point");
var progressBar = $("#progressWidth");
var GLOBAL = {
...
//     if(prop == 0){
//         speaker.style.background = "url(" +GLOBAL.volume.mute+")";
//     }else if(prop > 0 && prop <33){
//         speaker.style.background = "url(" +GLOBAL.volume.low+")";
//     }else if(prop >= 33 && prop < 66){
//        speaker.style.background = "url(" +GLOBAL.volume.middle+")";

//     }else{
//        speaker.style.background = "url(" +GLOBAL.volume.height+")";
...
//     progressWidth.style.width = _left + 15 + "px";
//     return parseInt((_left + 15) / GLOBAL.proWidth*100);
// }

// point.addEventListener("mousedown" , handlerVolumeChangeStart);
