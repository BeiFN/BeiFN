...
// 创建子弹;
 ...
 var end_fish = setInterval( createRandomLetter , 1000);
...
var remaintime = 60;
var scords = document.getElementById("scords");
...
var intver_end = setInterval(function(){
     remaintime --;
     second.innerHTML = remaintime;
     scords.innerHTML = scoerCount;
     if(remaintime <= 0 || scoerCount < 0 ){
          clearInterval(intver_end);
          clearInterval(end_fish);
